...
for file_name in csv_files:
    ...
    print(f"File '{file_path}' MCC (SVC): {mcc_svc}, Accuracy (SVC): {accuracy_svc}, 특이도 (Specificity): {specificity}, 민감도 (Sensitivity): {sensitivity}")

# 결과를 txt 파일에 저장
output_file_path = "./svc_combi_ACP.txt"
