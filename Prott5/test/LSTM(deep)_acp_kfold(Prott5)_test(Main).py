...
# Main Test 
new_data_file_path = './Dataset/test/protein_embeddings_prott5.csv'
...
scaler = joblib.load('./Prott5/LSTM(deep)_Prott5_weights/scaler_LSTM(deep)_Prott5.pkl')
X_combined_scaled_new = scaler.fit_transform(X_prott5_new)
...
best_model_paths_acc = [
    './Prott5/LSTM(deep)_Prott5_weights/best_model_fold_1_acc.pth',
    './Prott5/LSTM(deep)_Prott5_weights/best_model_fold_2_acc.pth',
    './Prott5/LSTM(deep)_Prott5_weights/best_model_fold_3_acc.pth',
    './Prott5/LSTM(deep)_Prott5_weights/best_model_fold_4_acc.pth',
    './Prott5/LSTM(deep)_Prott5_weights/best_model_fold_5_acc.pth'
]
...
result_df.to_csv('./Prott5/results/Prott5_test_results(Main)_acc.csv', index=False)
